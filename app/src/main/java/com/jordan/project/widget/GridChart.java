...
public class GridChart extends View implements IViewConst, ITouchEventNotify,ITouchEventResponse {
	...
	// ////////////默认值////////////////
	/** 默认背景色 */
	public static final int DEFAULT_BACKGROUD_COLOR = 0x00000000;
	...
	/** 默认经线是否显示刻度 */
	public static final boolean DEFAULT_DISPLAY_LONGTITUDE = Boolean.FALSE;
	...
	/** 默认是否显示X轴刻度 */
	public static final boolean DEFAULT_DISPLAY_AXIS_X_TITLE = Boolean.FALSE;

	/** 默认是否显示Y轴刻度 */
	public static final boolean DEFAULT_DISPLAY_AXIS_Y_TITLE = Boolean.FALSE;
	...
	/** 默认经线刻度字体颜色 **/
	private int DEFAULT_LONGTITUDE_FONT_COLOR = 0x6A6A6A;

	/** 默认经线刻度字体大小 **/
	private int DEFAULT_LONGTITUDE_FONT_SIZE = 25;

	/** 默认经线刻度字体颜色 **/
	private int DEFAULT_LATITUDE_FONT_COLOR = 0x6A6A6A;

	/** 默认经线刻度字体颜色 **/
	private int DEFAULT_LATITUDE_FONT_SIZE = 25;
