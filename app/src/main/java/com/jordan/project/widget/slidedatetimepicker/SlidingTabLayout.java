...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private TabChangeNotify tabChangeNotify;
    public interface TabChangeNotify {

        void tabChangeNotify(int position);
     ...
     */
    public void setViewPager(ViewPager viewPager,TabChangeNotify tabChangeNotify) {
        this.tabChangeNotify = tabChangeNotify;
    ...
    private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            if(tabChangeNotify!=null)
                tabChangeNotify.tabChangeNotify(position);
        }
