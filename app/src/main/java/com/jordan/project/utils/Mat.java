...
public class Mat {
	...
	public static void swap(ArrayList<com.jordan.project.utils.Point> xy, int i, int j) {
	...
	public static float getdist(com.jordan.project.utils.Point p1, com.jordan.project.utils.Point p2) {
		return (float) Math.sqrt(
				(p2.getX() - p1.getX()) * (p2.getX() - p1.getX()) + (p2.getY() - p1.getY()) * (p2.getY() - p1.getY()));
	}

	public static float getcross(com.jordan.project.utils.Point p0, com.jordan.project.utils.Point p1, com.jordan.project.utils.Point p2) {
		return (p1.getX() - p0.getX()) * (p2.getY() - p0.getY()) - (p2.getX() - p0.getX()) * (p1.getY() - p0.getY());
	}

	public static float getdot(com.jordan.project.utils.Point p0, com.jordan.project.utils.Point p1, com.jordan.project.utils.Point p2) {
		return (p1.getX() - p0.getX()) * (p2.getX() - p0.getX()) + (p1.getY() - p0.getY()) * (p2.getY() - p0.getY());
	}

	public static float anglecmp(com.jordan.project.utils.Point p0, com.jordan.project.utils.Point p1, com.jordan.project.utils.Point p2) {
	...
	public static void vectorsort(ArrayList<com.jordan.project.utils.Point> arr, int left, int right) {
		int i, mid, last;
	...
	public static void getconvex(ArrayList<com.jordan.project.utils.Point> arr, int len, ArrayList<Count> n) {
		int i, base, top;
	...
	public static void rotatingcalipers(ArrayList<com.jordan.project.utils.Point> arr, int len, ArrayList<com.jordan.project.utils.Point> rectangle) {
		int top, down=0, right = 1, up = 0, left = 0, downlast , rightlast, uplast, leftlast;

		float area = Float.MAX_VALUE, dist, X, Y, k;
		com.jordan.project.utils.Point temp=new com.jordan.project.utils.Point();
		...
		if(ret==len){
			com.jordan.project.utils.Point point=new com.jordan.project.utils.Point();
			arr.add(point);
		}
	...
	public static void variance_analysis(ArrayList<com.jordan.project.utils.Point> xy, int len)
	{
		int i;
	...
	public static void variance_analysis_v2(ArrayList<com.jordan.project.utils.Point> xy, int index, int len)
	{
		int i;
		float sumx=0.0f,sumy=0.0f,avex=0.0f,avey=0.0f,varx=0.0f,vary=0.0f,stdx=0.0f,stdy=0.0f;
	...
	static int is_full(ArrayList<com.jordan.project.utils.Point> xy, int len){
		
		int i;
		
		variance_analysis(xy, len);
		com.jordan.project.utils.Point min=new com.jordan.project.utils.Point(xy.get(0).getX(),xy.get(0).getY());
		com.jordan.project.utils.Point max=new com.jordan.project.utils.Point(xy.get(0).getX(),xy.get(0).getY());
		int k=len>75?75:len;
		int j=len>75?15:1;
		for(i=j;i<k;i++){
	...
	static void data_conver(ArrayList<com.jordan.project.utils.Point> xy, ArrayList<com.jordan.project.utils.Point> pxy, int index, int len){
		
		int i;
		variance_analysis_v2(xy,index, len);
		ArrayList<com.jordan.project.utils.Point> b=new ArrayList<com.jordan.project.utils.Point>(){{add(new com.jordan.project.utils.Point(1f,1f));add(new com.jordan.project.utils.Point(1f,1f));add(new com.jordan.project.utils.Point(1f,1f));add(new com.jordan.project.utils.Point(1f,1f));}};


		ArrayList<com.jordan.project.utils.Point> xy_temp=new ArrayList<com.jordan.project.utils.Point>();
		for(i=index;i<len+index;i++){
			com.jordan.project.utils.Point point=new com.jordan.project.utils.Point(xy.get(i).getX(),xy.get(i).getY());
			xy_temp.add(point);
		}
		...
		com.jordan.project.utils.Point max_y=new com.jordan.project.utils.Point(0.0f,0.0f);
		com.jordan.project.utils.Point min_x=new com.jordan.project.utils.Point(0.0f,0.0f);
		com.jordan.project.utils.Point min_y=new com.jordan.project.utils.Point(0.0f,0.0f);
		...
		com.jordan.project.utils.Point p_max_y=new com.jordan.project.utils.Point();
		com.jordan.project.utils.Point p_min_x=new com.jordan.project.utils.Point();
		com.jordan.project.utils.Point p_min_y=new com.jordan.project.utils.Point();
...
static void data_conver_v2(ArrayList<com.jordan.project.utils.Point> xy, ArrayList<com.jordan.project.utils.Point> pxy, int index, int len){
		...
		com.jordan.project.utils.Point max_y=new com.jordan.project.utils.Point(b.get(0).getX(),b.get(0).getY());
		com.jordan.project.utils.Point max_x=new com.jordan.project.utils.Point(b.get(0).getX(),b.get(0).getY());
		com.jordan.project.utils.Point min_x=new com.jordan.project.utils.Point(b.get(0).getX(),b.get(0).getY());
		com.jordan.project.utils.Point min_y=new com.jordan.project.utils.Point(b.get(0).getX(),b.get(0).getY());
		...
		com.jordan.project.utils.Point p_min_x=new com.jordan.project.utils.Point();
		com.jordan.project.utils.Point p_min_y=new com.jordan.project.utils.Point();
		com.jordan.project.utils.Point p_max_x=new com.jordan.project.utils.Point();
		p_max_y.setX(max_y.getX()*cos_yaw - max_y.getY()*sin_yaw);
		p_max_y.setY(max_y.getY()*cos_yaw + max_y.getX()*sin_yaw);
		...
		com.jordan.project.utils.Point zero=new com.jordan.project.utils.Point(0.0f,0.0f);
		...
		com.jordan.project.utils.Point new_p_max_y=new com.jordan.project.utils.Point();
		com.jordan.project.utils.Point new_p_min_x=new com.jordan.project.utils.Point();
		com.jordan.project.utils.Point new_p_min_y=new com.jordan.project.utils.Point();
	...
	public static void data_analysis_v3(ArrayList<com.jordan.project.utils.Point> xy, int len, ArrayList<com.jordan.project.utils.Point> pxy, int full){
		int i;
		if (full == 0) {
			width = 15;
			height = 14;
	...
	public static void data_analysis_v2(ArrayList<com.jordan.project.utils.Point> xy, int len, ArrayList<com.jordan.project.utils.Point> pxy){
		int full=0;
		int i;
		if(len>100){
			full=is_full(xy, 100);
	...
	public static void data_analysis(ArrayList<com.jordan.project.utils.Point> xy, int len, ArrayList<com.jordan.project.utils.Point> pxy)
	{
		int i;
