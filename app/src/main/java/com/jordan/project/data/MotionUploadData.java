...
public class MotionUploadData {
    ...
    public String toString() {
        return "MotionUploadData{" +
                ...
                ", totalDist='" + totalDist + '\'' +
                ", totalStep='" + totalStep + '\'' +
                ", totalHorDist='" + totalHorDist + '\'' +
                ", totalVerDist='" + totalVerDist + '\'' +
                ", totalTime='" + totalTime + '\'' +
                ...
                ", breakinCount='" + breakinCount + '\'' +
                ", breakinAvgTime='" + breakinAvgTime + '\'' +
                ", verJumpPoint='" + verJumpPoint + '\'' +
                ", verJumpCount='" + verJumpCount + '\'' +
                ", verJumpAvgHigh='" + verJumpAvgHigh + '\'' +
                ", verJumpMaxHigh='" + verJumpMaxHigh + '\'' +
                ", avgHoverTime='" + avgHoverTime + '\'' +
                ", avgTouchAngle='" + avgTouchAngle + '\'' +
                ", touchType='" + touchType + '\'' +
                ", perfRank='" + perfRank + '\'' +
                ", runRank='" + runRank + '\'' +
                ", breakRank='" + breakRank + '\'' +
                ", bounceRank='" + bounceRank + '\'' +
                ", avgShotDist='" + avgShotDist + '\'' +
                ", maxShotDist='" + maxShotDist + '\'' +
                ", handle='" + handle + '\'' +
                ", calorie='" + calorie + '\'' +
                ", trail='" + trail + '\'' +
                ", ballType='" + ballType + '\'' +
