...
public final class JoinListInfo extends JsonInfo {
    ...
    public JoinListInfo(String pageNo, String pageSize) {
        mPageNo=pageNo;
        mPageSize=pageSize;
    }
    ...
    public String toJsonStr() {
        try {
            ...
            json_object.put(UserSystemConfig.GetJoinListConfig.JSON_REQUEST_PAGE_NO, mPageNo);
            json_object.put(UserSystemConfig.GetJoinListConfig.JSON_REQUEST_PAGE_SIZE, mPageSize);
